# Jalon 4 — SEO automatique

Tu entres en mode plan pour planifier puis construire le jalon 4 de ce projet.
...
1. Planifie l'implémentation du **seul** jalon 4 tel que défini dans le PRD. Ne planifie ni ne construis rien qui relève des jalons suivants.
2. Après validation du plan par l'utilisateur, construis uniquement ce qui est dans le périmètre du jalon 4.
3. Vérifie ton travail contre le critère « Terminé quand » du jalon 4 dans le PRD.
4. Une fois terminé, écris un `milestone-log.md` dans ce dossier (`_build_plan/milestones/4-seo/milestone-log.md`), structuré ainsi :
