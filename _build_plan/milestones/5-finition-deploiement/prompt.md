# Jalon 5 — Finition, sécurité & mise en ligne

Tu entres en mode plan pour planifier puis construire le jalon 5 de ce projet.
...
1. Planifie l'implémentation du **seul** jalon 5 tel que défini dans le PRD. Ne planifie ni ne construis rien qui relève des jalons suivants.
2. Après validation du plan par l'utilisateur, construis uniquement ce qui est dans le périmètre du jalon 5.
3. Vérifie ton travail contre le critère « Terminé quand » du jalon 5 dans le PRD.
4. Une fois terminé, écris un `milestone-log.md` dans ce dossier (`_build_plan/milestones/5-finition-deploiement/milestone-log.md`), structuré ainsi :
