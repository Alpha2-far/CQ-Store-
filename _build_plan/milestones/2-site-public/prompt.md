...
Tu entres en mode plan pour planifier puis construire le jalon 2 de ce projet.
...
1. Planifie l'implémentation du **seul** jalon 2 tel que défini dans le PRD. Ne planifie ni ne construis rien qui relève des jalons suivants.
2. Après validation du plan par l'utilisateur, construis uniquement ce qui est dans le périmètre du jalon 2.
3. Vérifie ton travail contre le critère « Terminé quand » du jalon 2 dans le PRD.
4. Une fois terminé, écris un `milestone-log.md` dans ce dossier (`_build_plan/milestones/2-site-public/milestone-log.md`), structuré ainsi :
