...
Community 0: dashboard.ejs, login.ejs, claude/install-bm-skills-g64nae, main, form.ejs, index.ejs, 0778fb7 Ajout du PRD GQ Store et des prompts de jalons, 813e9d0 feat: Complete GQ Store implementation (Milestones 1, f11430a chore(render): set startCommand to npm start directl, f4b697f fix(prod): enable trust proxy for secure cookie sess, graphify-post-tool.js, { execSync } [lang=fr]
...
Community 7: admin.routes.js, authRoutes, brandRoutes, categoryRoutes, dashboardController, express, productRoutes, { requireAuth }, router [lang=en]
Community 8: Product, migration.sql, Admin, Brand, Category, ProductPhoto, Specification [lang=en]
Community 9: app.test.js, app, assert, http, prisma, { test, describe, before, after } [lang=en]
Community 10: cart.test.js, app, assert, http, prisma, { test, describe, before, after } [lang=en]
Community 11: public.test.js, app, assert, http, prisma, { test, describe, before, after } [lang=en]
